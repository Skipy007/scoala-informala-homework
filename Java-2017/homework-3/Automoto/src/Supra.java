 ...
 */
public class Supra extends Toyota implements Car {
    boolean started = false;
    protected int maxGear = 6, currentGear = 0;
    protected double tankSize = 80, coef = 0, maxConsum = 0.50 , drivenKm = 0, literConsum = 0, lPer100Km = 0, gasCoef = 0, tireCoef;
   public Supra(double fuelInTank, String serialNumber, int weelWith, String fuelType ){
    ...
    public void start() {
        if (fuelInTank > 0) {
            ...
            currentGear = 0;
            lPer100Km = 0;
            if (fuelType.equals("BENZINE")){gasCoef=0.08;} else {gasCoef = 0.01;}
            System.out.println(gasCoef);
            if (weelWith<=195){tireCoef=0.03;} else {tireCoef = 0.3;}
            System.out.println(tireCoef);
